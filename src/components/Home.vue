<template>
    <div class="container">
        ...
        <div class="carousel">
            <Carousel autoplay>
            <Carousel-item :key="carousel" v-for="(item ,index) in banner" >
        ...
        <div class="newslist">
            <div :key="newslist" v-for="(listitem ,index) in newslist" v-tap="{ methods: toListDetail, index: index }" class="newslist_item">
