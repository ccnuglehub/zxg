	...
	<div class="register">
		...
		<div class="m_box">
			<div class="input mb_input">
				<div class="m_input_box">
					<Input v-model="form_data.user_tel" @on-blur="phoneValidate(form_data.user_tel)" class="m_input" placeholder="请输入电话">
		...
		<div class="select_box">
			...
			<Select v-model="form_data.user_type" class="select">
				<Option v-for="(item, index) in user_type_list" :value="item.value" :key="index">{{ item.value }}</Option>
			</Select>
		</div>
		<div class="select_box">
			<label class="select_lable"></label>
			<Select v-model="form_data.user_work_type" class="select">
				<Option v-for="(item, index) in user_work_type_list" :value="item.value" :key="index">{{ item.value }}</Option>
			</Select>
		</div>
